...
- (CGSize)mediaViewDisplaySize
{
    ...
    if (! self.playButtonImage) {
        self.playButtonImage = [[UIImage imageNamed:@"play.png"] jsq_imageMaskedWithColor:self.tintColor];
    }
    if (! self.pauseButtonImage) {
        self.pauseButtonImage = [[UIImage imageNamed:@"pause.png"] jsq_imageMaskedWithColor:self.tintColor];
    }
